...
function cv_daily_rashi_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_rashi_' . md5(json_encode($atts));
...
function cv_daily_horoscope_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_daily_horo_' . md5(json_encode($atts));
    $html = get_transient($transient_key);
...
function cv_weekly_horoscope_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_weekly_horo_' . md5(json_encode($atts));
    $html = get_transient($transient_key);
...
function cv_transit_horoscope_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_transit_' . md5(json_encode($atts));
    $html = get_transient($transient_key);
...
function cv_horoscope_unified_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_unified_horo_' . md5(json_encode($atts));
    $html = get_transient($transient_key);
...
function cv_testimonials_shortcode($atts) {
    ...
    $transient_key = 'cv_shortcode_testimonials_' . md5(json_encode($atts));
    $html = get_transient($transient_key);
